...
process.generator = cms.EDProducer("FlatRandomEGunProducer",
    PGunParameters = cms.PSet(
        PartID = cms.vint32(2112,2112),
        MinEta = cms.double(-9.0),
        MaxEta = cms.double(-8.0),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('simevent_debug.root'),
...
process.g4SimHits.Watchers = cms.VPSet(cms.PSet(
    ...
    ZdcTestAnalysis = cms.PSet(
		...
		StepNtupleFlag = cms.int32(1),
        EventNtupleFlag = cms.int32(1),
        StepNtupleFileName = cms.string('stepNtuple_debug.root'),
        EventNtupleFileName = cms.string('eventNtuple_debug.root')
	)   	
))
