...
# added to load special geometry
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('simevent_Geant.root'),
...
process.g4SimHits.Watchers = cms.VPSet(cms.PSet(
    ...
    ZdcTestAnalysis = cms.PSet(
        ...
        StepNtupleFileName = cms.string('stepNtuple_Geant.root'),
        EventNtupleFileName = cms.string('eventNtuple_Geant.root')
	)   	
))
