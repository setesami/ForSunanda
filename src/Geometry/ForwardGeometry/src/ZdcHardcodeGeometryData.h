...
/*New flow detector stuff...basing off of Edmundo's drawing above, this looks like
||||||||||||||    |          |||||||||
^                 ^          ^
|                 |          |
zlow-em           zlow-rpd   zlow-had
*/
//MAYBE I SHOULD REVERSE THESE NUMBERS????
static const double theXRPDChannelBoundaries[]={-25.375,-0.375,24.625,49.625};
static const double theYRPDChannelBoundaries[]={-61.875,-31.875,-1.875,28.125};
static const double theZRPDChannelBoundaries=-348.5;
static const double dYRPD=15;
static const double dXRPD=12.5;
